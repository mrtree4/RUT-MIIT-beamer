...
Вместо конкретных численных значений ширины можно, например, задавать размер по ширине текста через width=\textwidth \texttt{\textbf{width = \textbackslash textwidth}}.
\end{frame}
